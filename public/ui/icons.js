...
(function () {
  var SYMBOLS = {
    ...
    fist: '<path d="M6.5 9.5c0-1 .8-1.8 1.8-1.8h.9V6.2c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v1.5h.7V5.6c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v2.1h.6c1 0 1.8.8 1.8 1.8v5.2c0 3.4-2.7 6.1-6.1 6.1h-1.4c-3.4 0-6.1-2.7-6.1-6.1v-2c0-1.7.9-2.6 1.8-3z"/><path d="M4.6 11.2c-1 .3-1.6 1.2-1.6 2.2 0 1.6.9 2.9 2.1 3.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',
    caretDown: '<path d="M6 9h12l-6 7z"/>'
  };
