...
static func installer_ambiance(parent: Node3D) -> void:
	...
	soleil.directional_shadow_max_distance = 26.0
	soleil.shadow_blur = 2.0
	# Biais généreux : le grand sol plat de l'île raye sans cela.
	soleil.shadow_bias = 0.14
	soleil.shadow_normal_bias = 4.5
